            ...
            <article>
                ...
                <section>
                    ...
                    <?php
                        ...
                        echo "<h4>Testar bussen:</h4>";
                        $bus1 = new Bus ("Volvo", "Skolbuss", 2020);
                        echo "<p>" . $bus1->getBus() . "</p>";
                        echo "<p>Informationen som skrevs in om bussen körd genom Vehicle-klassen är: " . $bus1->getVehicle();
